...
- `npm run start:dev` — dev server with watch (port 3005)
...
- App port **3005**; CORS is open for `http://localhost:4200` (the React frontend, via the BFF in
