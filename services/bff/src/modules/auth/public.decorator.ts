 ...
 * (registered as `APP_GUARD` in `AppModule`). Every route is protected by default (AD-5); a
 * route opts OUT via this decorator, never the other way around. Only `/health` uses this today.
 */
